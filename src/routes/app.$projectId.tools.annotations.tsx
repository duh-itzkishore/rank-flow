...
export const Route = createFileRoute("/app/$projectId/tools/annotations")({ component: () => <ComingSoon title="Annotations" desc="Add notes and labels to specific AI responses to flag trends, issues, or opportunities for your team." /> });

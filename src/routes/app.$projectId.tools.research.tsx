...
export const Route = createFileRoute("/app/$projectId/tools/research")({ component: () => <ComingSoon title="Prompt Research" desc="Discover new high-impact prompts to track by analyzing what users are asking AI models about your category." /> });

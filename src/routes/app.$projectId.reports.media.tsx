...
export const Route = createFileRoute("/app/$projectId/reports/media")({ component: () => <ComingSoon title="Owned Media" desc="Track performance of your owned content in AI-generated responses and citations." /> });

...
import { Loader2, Sparkles, AlertCircle, TrendingUp, CheckCircle, Lightbulb } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-white tracking-tight flex items-center gap-2">
            <Sparkles className="w-6 h-6 text-indigo-400" /> AI Insights Engine
          </h1>
          <p className="mt-1 text-sm text-white/40">Actionable recommendations, risk detections, and performance analysis</p>
        </div>

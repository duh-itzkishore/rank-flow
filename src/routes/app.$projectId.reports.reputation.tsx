...
export const Route = createFileRoute("/app/$projectId/reports/reputation")({ component: () => <ComingSoon title="Reputation Monitor" desc="Monitor and score your brand's overall reputation as perceived by AI systems over time." /> });

...
export const Route = createFileRoute("/app/$projectId/reports/fanout")({ component: () => <ComingSoon title="Query Fan Out" desc="Visualize how AI models expand a single query into related sub-queries to find your brand." /> });
